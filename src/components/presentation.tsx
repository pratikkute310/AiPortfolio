...
export function Presentation() {
  ...
  const profile = {
    ...
    description:
      "Hey 👋\nI'm Pratik Kute better call me PK. I'm a Software Engineer and AI enthusiast from Pune, Mh, India. I'm interested in AI, tech, building new things and SaaS tech.",
    src: '/image_dummy.jpg',
    fallbackSrc:
    ...
    <div className="mx-auto w-full max-w-5xl py-6 font-sans">
      <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-2">
        ...
        <div className="flex flex-col space-y">
          ...
          >
            {['AI', 'Developer', 'Sofware Engineer', 'Frontend Developer', 'Backend Developer', 'Data Engineer', 'Data Scientist'].map(
              (tag) => (
                <span
                  key={tag}
