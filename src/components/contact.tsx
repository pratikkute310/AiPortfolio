...
export function Contact() {
  ...
  const contactInfo = {
    ...
    socials: [
      {
        name: 'LinkedIn',
        url: 'https://www.linkedin.com/in/pratik-kute-b9a572206/',
      },
      {
        name: 'Instagram',
        url: 'https://www.instagram.com/pratik__310/',
      },
      // {
      //   name: 'Discord',
      ...
      {
        name: 'Github',
        url: 'https://github.com/pratikkute310',
      },
      {
        name: 'X',
        url: 'https://x.com/Pratik_K310',
      },
    ],
  };
